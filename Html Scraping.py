...
will use urllib to read the HTML from the data files below, and parse the
...
Actual data: http://py4e-data.dr-chuck.net/comments_260988.html (Sum ends with 19)
...
html = urlopen('http://py4e-data.dr-chuck.net/comments_260988.html', context=ctx).read()
